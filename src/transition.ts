...
export function loadData() {
    ...
    if (jg) {
        if (temps === 0) {
            ...
            Avec un jet de ${saveCampestri().save} , ilparvient à attraper le bébé campestri et à le sortir du chaudron avant qu'il ne soit trop tard. 
            ...
            if (saveCampestri().success == false) {
                 jg.innerHTML = `Comme vous avez pris trop de temps à vous préparer à cet affrontement. Avec une jauge de vitesse de ${temps}, les conséquences
            sont désastreuses...<br> <br>
            ...
            Avec un jet de ${saveCampestri().save} , il ne parvient pas à attraper le bébé campestri et à le sortir du chaudron avant qu'il ne soit trop tard. 
...
function saveCampestri() {
    let save = Math.floor(Math.random() * 19) + 1;
    let needed = 10;
    let success = false;
